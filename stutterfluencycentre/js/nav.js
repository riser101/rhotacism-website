...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const basePath = '/stutterfluencycentre';

    // Load login-modal.js script first
    const loginModalScript = document.createElement('script');
    loginModalScript.src = basePath + '/js/login-modal.js?v=20260722';
    loginModalScript.onload = function() {
        ...
        if (existingNav) {
            ...
            fetch(basePath + '/includes/nav.html?v=20260722')
    ...
    googleSignInScript.src = basePath + '/js/google-signin-init.js?v=20260722';
    googleSignInScript.onload = function() {
        // After google-signin-init.js is loaded, load the modal HTML
        fetch(basePath + '/includes/login-modal.html?v=20260722')
            .then(response => response.text())
            .then(html => {
