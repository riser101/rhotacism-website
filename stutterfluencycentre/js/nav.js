...
document.addEventListener('DOMContentLoaded', function() {
    ...
    loginModalScript.src = basePath + '/js/login-modal.js?v=20260822';
    loginModalScript.onload = function() {
        ...
        if (existingNav) {
            ...
            fetch(basePath + '/includes/nav.html?v=20260822')
    ...
    googleSignInScript.src = basePath + '/js/google-signin-init.js?v=20260822';
    googleSignInScript.onload = function() {
        // After google-signin-init.js is loaded, load the modal HTML
        fetch(basePath + '/includes/login-modal.html?v=20260822')
            .then(response => response.text())
            .then(html => {
