...
document.addEventListener('DOMContentLoaded', function() {
    ...
    loginModalScript.onload = function() {
        ...
        if (existingNav) {
            ...
            fetch(basePath + '/includes/nav.html?v=20260707')
    ...
    googleSignInScript.src = basePath + '/js/google-signin-init.js?v=20260707';
    googleSignInScript.onload = function() {
        // After google-signin-init.js is loaded, load the modal HTML
        fetch(basePath + '/includes/login-modal.html?v=20260707')
            .then(response => response.text())
            .then(html => {
